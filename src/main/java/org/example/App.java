...
·        Tworzymy zmienne a, b, c, d, e, f, g, h, i, k, l, m, p, zmienną przechowującą podany przez użytkownika rok, a także obliczony dzień i miesiąc
...
Aby wyznaczyć dzień Wielkanocy do p należy dodać 1, z kolei do wyznaczania miesiąca trzeba zaokrąglając w dół podzielić (h + l – 7 * m + 114) przez 31.
Jeżeli miesiąc wyszedł nam 4, wówczas Wielkanoc odbędzie się w kwietniu. W każdym innym przypadku w marcu.
...
c)     W niektórych punktach algorytmu należy zaokrąglić wynik w dół z dzielenia. W jaki sposób możesz to zrobić? Czy potrzebujesz do tego specjalnej metody?
d)     Przy pomocy jakiej klasy możesz pobrać od użytkownika rok? Jakie znasz inne metody wprowadzania danych do aplikacji (niekoniecznie przy pomocy klawiatury)?
e)     Przystąp do implementacji algorytmu. Przed rozpoczęciem pracy spróbuj rozpisać każde działanie na kartce.
Na wyjściu zwróć datę w formacie dd MIESIAC rrrr np. dla roku 2015 Twój program powinien zwrócić 5 kwiecień 2015.\
 */
